            ...
            <Box px={{ base: 4, md: 8 }} py={8} w={{ base: "100%", md: "30%" }} p={"20px"} >
                <Box overflowX={"hidden"} overflowY={"scroll"} maxHeight={"300px"} marginBottom={"20px"}>
                    <Box bg="white" border="2px solid black" borderBottom={"none"} w="100%" p={4}>
                        ...
                        <Text color={"#757575"} fontSize="lg">Your Average Score: <span style={{ "color": "red" }}>{user.easyScore}%</span></Text>
                    ...
                    <Box bg="white" border="2px solid black" borderBottom={"none"} w="100%" p={4}>
                        ...
                        <Text color={"#757575"} fontSize="lg">Your Average Score: <span style={{ "color": "red" }}>{user.mediumScore}%</span></Text>
                    ...
                    <Box bg="white" border="2px solid black" borderBottom={"none"} w="100%" p={4}>
                        ...
                        <Text color={"#757575"} fontSize="lg">Your Average Score: <span style={{ "color": "red" }}>{user.hardScore}%</span></Text>
